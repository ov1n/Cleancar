...
<html>
    ...
    <head>
        ...
        <script type="text/javascript" src="public/js/add_timeslot.js"></script> <!-- link to js file -->
    ...
    <!-- onsubmit="send_timeslot_data()" -->
      ...
      <form name="add_timeslot_form" id="add_timeslot_form" method = "post" onsubmit="send_timeslot_data()">   <!-- call function in js file -->  
        <div class="container">  

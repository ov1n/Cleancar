          ...
          <div class="background">
            ...
            <div class="card" >
              <div id=form_content> <!-- div to center needed elements -->
                ...
                &ensp;&ensp;<label for="servise_type"><div class="form_label"><b>Service Type</b></div></label>
                <input type="text" placeholder="Enter the Service Type" value = '<?php echo "$array[servise_type]"; ?>' name="servise_type" id="servise_type"></br>

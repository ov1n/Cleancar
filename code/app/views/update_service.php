...
<html>
    ...
    <body>
      ...
      <form name="service_update_form" id="service_update_form" method = "post" onsubmit="send_update_data()" >
        <div class="container">  
              ...
              <div id=form_content> <!-- div to center needed elements -->
                ...
                &ensp;&ensp;<label for="service_type"><div class="form_label"><b>Service Type</b></div></label>
                  <select name="service_type" id="service_type">
                    ...
                    <option value="<?php echo "$array[type_name]"; ?>"><?php echo "$array[type_name]"; ?></option>
                ...
                &ensp;&ensp;<label for="vehicle_category"><div class="form_label"><b>Vehicle Category</b></div></label>
                  <select name="vehicle_category" id="vehicle_category">
                     <option value="<?php echo "$array[vehicle_category]"; ?>"><?php echo "$array[vehicle_category]"; ?></option>
                ...
                <input type="text" placeholder="Enter number of emploees" name="no_of_employees" id="no_of_employees" value = '<?php echo "$array[no_of_emp]"; ?>' required size="50"></br>

                &ensp;&ensp;<label for="no_of_time_slot"><div class="form_label"><b>No of time slots</b></div></label>
                <input type="text" placeholder="Enter number of time slot" name="no_of_time_slot" id="no_of_time_slot" value = '<?php echo "$array[duration]"; ?>' required size="50"></br>

                &ensp;&ensp;<label for="lift_no"><div class="form_label"><b>Lift Number</b></div></label>
                  <select name="lift_no" id="lift_no">
                     <option value="<?php echo "$array[lift_no]"; ?>"><?php echo "$array[lift_no]"; ?></option>

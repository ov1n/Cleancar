            ...
            <div class="card" >
              <div id=form_content> <!-- div to center needed elements -->
                <label for="Number Of Leave You Got" style="width: 280px" ><div class="form_label"><b>Number Of Leave You Got upto Today</b></div></label>
                 <div class="form_label" style="margin:50px;color: black">Full Day&ensp;&ensp; <?php echo($array[0]['no_of_leaves_short']); ?> &ensp;&ensp;&ensp;&ensp;&ensp;Half Day&ensp;&ensp; <?php echo "$array[no_of_leaves_halfday]"; ?> &ensp;&ensp;&ensp;&ensp;&ensp;Short Leave&ensp;&ensp; <?php echo "$array[no_of_leaves_fullday]"; ?> </div>

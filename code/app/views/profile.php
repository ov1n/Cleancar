  ...
  margin-right: auto;">
                    <div id=form_content>
                        ...
                        <input type="text" placeholder="Enter Your First Name" name="first_name"
                            value='<?php echo "$array[first_name]"; ?>' id="first_name" required disabled></br>
                        ...
                        <input type="text" placeholder="Enter Your Last Name" name="last_name"
                            value='<?php echo "$array[last_name]";?>' id="last_name" required disabled></br>

                        &ensp;&ensp;<label for="nic">
                            <div class="form_label"><b>NIC</b></div>
                        </label>
                        <input type="text" placeholder="Enter Your Nic" name="nic"
                            value='<?php echo "$array[NIC_no]";?>' id="nic" required disabled></br>

                        &ensp;&ensp;<label for="address">
                            <div class="form_label"><b>Address</b></div>
                        </label>
                        <input type="text" placeholder="Enter Your Address" name="address"
                            value='<?php echo "$array[address]";?>' id="address" required disabled></br>

                        &ensp;&ensp;<label for="e-mail">
                            <div class="form_label"><b>Email</b></div>
                        </label>
                        <input type="email" placeholder="Enter Your Email Address" name="e-mail"
                            value='<?php echo "$array[email]";?>' gmail.com" id="e-mail" required disabled></br>
                        ...
                        <input type="text" placeholder="Enter Your mobile number" name="mobile_tel_no"
                            value='<?php echo "$array[mobile_tel_no]";?>' id="mobile_tel_no" required disabled></br>
                        ...
                        <input type="text" placeholder="Enter Your Home number" name="home_tel_no"
                            value='<?php echo "$array[home_tel_no]";?>' id="home_tel_no" required disabled>
                        </br>

...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2021 at 03:03 PM
...
(1043, 'Thenuka', 'Weerasinghe', '900 Zone 34', 'thenukaovin@gmail.com', '0112334511', '0711755793', 0, '2020-11-13', 'a8f68a7d03245c5e7f4d090abb01853e43dbfac5'),
...
('M001', 'saman', 'lenin', 'no 20,matara', 'manager1123@gmail.com', ' 0115467884', ' 0789871211', '875542104', 5, 4, 7, '2020-09-23', 'MBA', '1a8565a9dc72048ba03b4156be3e569f22771f23');
...
('R001', 'minuri', 'withanage', 'thelijjawila ,matara', ' receptionist1@gmail.com', '0112547891', '0764872527', '  90245741', 5, 4, 4, '2020-10-01', 'SQL', '3b6f5b1c6ffdf5e9d335132d6b6ae9dbca0fd269');
...
(2012, 'kamal', 'withana', 'kasun', 'wondersounds96@gmail.com', '0412283616', '0783441660', '961016522v', 'Male', '1996-04-10', 0, 0, 0, '2021-02-11', '', '114a42d736ced0dce1affc1e898c69b3998426df');
...
(7, 'body wash', 'van', 4, 1, '1', 10000),
(8, 'Normal Service', 'car', 2, 1, '3', 7000);
...
--
ALTER TABLE `service_employee`
  MODIFY `emp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2013;
...
--
ALTER TABLE `reservation`
  ADD CONSTRAINT `reservation_ibfk_1` FOREIGN KEY (`service_id`) REFERENCES `service_type` (`type_id`) ON DELETE CASCADE ON UPDATE CASCADE,

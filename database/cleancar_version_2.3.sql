...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2021 at 11:49 AM
...
(1088, 'Minuri', 'Wickramanayaka', 'kalutara', 'yasara@gmail.com', '0342287472', '0769226787', 0, '2021-03-18', 'a642a77abd7d4f51bf9226ceaf891fcbb5b299b8'),
(1089, 'Minuri', 'Wickramanayaka', 'kalutara', 'yasara@gmail.com', '0342287472', '0769226787', 0, '2021-03-18', 'a642a77abd7d4f51bf9226ceaf891fcbb5b299b8'),
(1090, 'Yasara', 'Wickramanayaka', 'Kegalle', 'yasara@gmail.com', '0342267876', '0771122334', 0, '2021-03-23', 'a642a77abd7d4f51bf9226ceaf891fcbb5b299b8');
...
('2021-01-26', 2003, 'Half Day', 'wedding', '00:00:12', ''),
('2021-02-02', 2001, 'Full_leave', 'party', '08:00:00', ''),
('2021-02-05', 2001, 'Full_leave', 'nnnnnnn', '08:00:00', 'accepted'),
('2021-03-01', 2013, 'short_leave', 'ghkysujbld', '08:00:00', 'pending'),
('2021-03-04', 2013, 'short_leave', 'wrgrbnynjdssndj', '08:00:00', 'Pending'),
('2021-03-27', 2013, 'Full_leave', 'party', '08:00:00', ''),
('2021-04-25', 2013, 'Full_leave', 'dsjanlknskhu', '08:00:00', 'Rejected');
...
(2006, 'Tharindu', 'Boothayaa', 'shanika, Akurugoda, Tellijjawila.', 'tdwithanage97@gmail.com', '0412241190', '0711565953', '971400757v', 'Male', '1997-05-19', 0, 0, 0, '2020-11-21', '', '25d55ad283aa400af464c76d713c07ad'),
(2013, 'Minuri', 'Wickramanayaka', 'Kalutara', 'yasarawickramanayaka@gmail.com', '0342287472', '0769226787', '966180056v', 'Female', '1996-04-27', 19, 20, 20, '2021-03-21', '', '85b77a2d069048802e427113acf327f6972603e5');
...
(61, 3, '15:30:00', '16:00:00'),
(62, 3, '16:00:00', '16:30:00'),
(63, 3, '16:30:00', '17:00:00');
...
--
ALTER TABLE `customer`
  MODIFY `cust_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1091;
...
--
ALTER TABLE `service_employee`
  MODIFY `emp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2014;
...
--
ALTER TABLE `time_slot`
  MODIFY `timeslot_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `invoice`
  ADD CONSTRAINT `invoice` FOREIGN KEY (`emp_id`) REFERENCES `service_employee` (`emp_id`) ON DELETE CASCADE ON UPDATE CASCADE;

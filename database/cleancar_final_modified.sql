...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2020 at 12:21 PM
...
(1000, 'Minuri', 'Yasara', 'Kalutara', 'minuri@gmail.com', 342287472, 769226787, 2, '2020-08-21', '123'),
(1001, 'Tharindu', 'Dulshan', 'Matara', 'tharinu@gmail.com', 451234567, 711223455, 1, '2020-10-01', '234');
...
--
ALTER TABLE `customer`
  MODIFY `cust_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1003;
